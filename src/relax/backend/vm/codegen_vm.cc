 ...
 */
Module CodeGen(IRModule mod, Optional<Module> lib, Array<Module> ext_mods,
  ...
  Module combined_lib = codegen::CreateMetadataModule(params_tmp, lib.value(), ext_mods,
                                                      host_target, relay::Runtime::Create("cpp"),
